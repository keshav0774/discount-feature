  ...
  theme: {
    extend: {
      colors: {
        ...
        'bg-elevated': '#0d0e10',
        'bg-card': '#121316',
        'bg-card-hover': '#17181c',
        border: '#1e1f23',
        'border-bright': '#302f36',
        text: '#f5f5f6',
        'text-dim': '#9a9ca4',
        'text-faint': '#55565d',
        accent: '#f5f5f6',
        'accent-soft': 'rgba(245, 245, 246, 0.08)',
        'accent-2': '#aeb0b8',
        'accent-2-soft': 'rgba(174, 176, 184, 0.08)',
        success: '#4ee1a0',
        danger: '#ff6b6b',
      },
      fontFamily: {
      ...
      keyframes: {
        'dot-pulse': {
          '0%': { boxShadow: '0 0 0 0 rgba(245,245,246,0.4)' },
          '70%': { boxShadow: '0 0 0 8px rgba(245,245,246,0)' },
          '100%': { boxShadow: '0 0 0 0 rgba(245,245,246,0)' },
        },
